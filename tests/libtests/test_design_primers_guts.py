...
def test_pos_strand(request, config_hg38, wtc11_targets_specs_set1):
...
def test_neg_strand(request, config_hg38, wtc11_targets_specs_set1):
...
def test_neg_strand_sj(request, config_hg38, wtc11_targets_specs_set1):
...
def test_FBXL16(request, config_hg38, wtc11_targets_specs_set1):
...
def test_too_short(request, config_hg38, wtc11_targets_specs_set1):
    ...
    with pytest.raises(PrimersJuJuDataError,
        ...
        run_primer_design_test(get_test_id(request), config_hg38, wtc11_targets_specs_set1,
                               "C19orf81+1")
